...
function addComments(name) {
    addToBuffer('<tr><td  style="text-align:center;" colspan="8"><b><br>Judging Notes: (Will not be shared with team)</b></td></tr><tr></tr><tr><td  colspan="8">\
      <textarea class="rbitem" id="text' + name + '1" width="100%" height="100%"></textarea>\
    </td></tr>')
}

function addLevels(color1, color2, color3, color4) {
    addToBuffer('<td bgcolor="' + color1 + '" class="rbtd" style="text-align: center;font-weight: bold;"><br>1<br>Beginner</td><td bgcolor="' + color2 + '" style="text-align: center;font-weight: bold;" class="rbtd"><br>2<br>Developing</td><td bgcolor="' + color3 + '" class="rbtd" style="text-align: center;font-weight: bold;"><br>3<br>Meets Expectations</td></td><td style="text-align: center;font-weight: bold;" bgcolor="' + color4 + '" class="rbtd"><br>4<br>Exceeds Expectations</td></td>')
}
